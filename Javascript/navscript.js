...
dropdown.addEventListener('click', ()=>{
    ...
    // ============== The dropdown variable would be toggled with the "toggle" class inwhich the css stylesheet holds transform adjustments to start an animation adjusting the contents rotation and size etc. ==============
